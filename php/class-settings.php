...
class Settings extends Component_Abstract {
	...
	public function add_submenu_pages() {
		add_submenu_page(
			...
			__( 'Block Lab Settings', 'block_lab' ),
			__( 'Settings', 'block_lab' ),
			'manage_options',
			$this->slug,
	...
	public function render_settings_page_header() {
		...
		<h2 class="nav-tab-wrapper">
			<a href="<?php echo esc_url( add_query_arg( 'tab', 'license' ) ); ?>" title="License" class="nav-tab nav-tab-active dashicons-before dashicons-nametag">
